...
# Psikoloji/zihin niş kanalları + CROSS-NİŞ besleyiciler (yan nişlerin viral fikirleri)
# Erkan Kolcu yöntemi: yan nişlerin kanıtlı viral fikirlerini psikolojiye uyarla.
RAKIP_KANALLAR = [
    {"name": "Psych2Go", "handle": "@Psych2go"},
    {"name": "Better Ideas", "handle": "@betterideas"},
    {"name": "The School of Life", "handle": "@theschooloflifetv"},
    {"name": "Charisma on Command", "handle": "@CharismaOnCommand"},
    {"name": "Improvement Pill", "handle": "@ImprovementPill"},
    {"name": "Sprouts", "handle": "@SproutsSchools"},
    {"name": "Practical Psychology", "handle": "@PracticalPie"},
    {"name": "TheraminTrees", "handle": "@TheraminTrees"},
]
